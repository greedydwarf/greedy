...
class ModelSaleOrder extends Model {
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, o.firstname, o.lastname,
				(SELECT CONCAT(c.firstname, ' ', c.lastname) FROM " . DB_PREFIX . "customer c WHERE c.customer_id = o.customer_id) AS customer,
				 ...
				 (SELECT op.name FROM " . DB_PREFIX . "order_product op WHERE op.order_id = o.order_id) AS game,
				 (SELECT op.quantity FROM " . DB_PREFIX . "order_product op WHERE op.order_id = o.order_id) AS quantity,
				  o.shipping_code, o.total, o.total_usd, o.currency_code, o.currency_value, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order` o";
