...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		//Настройки мейла и чека

		if (isset($this->request->post['config_mail_theme1'])) {
			$data['config_mail_theme'][1] = $this->request->post['config_mail_theme1'];
		} else {
			$data['config_mail_theme'][1] = $this->config->get('config_mail_theme1');
		}

		if (isset($this->request->post['config_mail_contentmail1'])) {
			$data['config_mail_contentmail'][1] = $this->request->post['config_mail_contentmail1'];
		} else {
			$data['config_mail_contentmail'][1] = $this->config->get('config_mail_contentmail1');
		}

		if (isset($this->request->post['config_mail_theme2'])) {
			$data['config_mail_theme'][2] = $this->request->post['config_mail_theme2'];
		} else {
			$data['config_mail_theme'][2] = $this->config->get('config_mail_theme2');
		}

		if (isset($this->request->post['config_mail_contentmail2'])) {
			$data['config_mail_contentmail'][2] = $this->request->post['config_mail_contentmail2'];
		} else {
			$data['config_mail_contentmail'][2] = $this->config->get('config_mail_contentmail2');
		}

		foreach ($data['languages'] as $language) {

			if (isset($this->request->post['config_mail_check_product' . $language['language_id']])) {
				$data['config_mail_check_product'][$language['language_id']] = $this->request->post['config_mail_check_product' . $language['language_id']];
			} else {
				$data['config_mail_check_product'][$language['language_id']] = $this->config->get('config_mail_check_product' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_quantity' . $language['language_id']])) {
				$data['config_mail_check_quantity'][$language['language_id']] = $this->request->post['config_mail_check_quantity' . $language['language_id']];
			} else {
				$data['config_mail_check_quantity'][$language['language_id']] = $this->config->get('config_mail_check_quantity' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_sum' . $language['language_id']])) {
				$data['config_mail_check_sum'][$language['language_id']] = $this->request->post['config_mail_check_sum' . $language['language_id']];
			} else {
				$data['config_mail_check_sum'][$language['language_id']] = $this->config->get('config_mail_check_sum' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_status' . $language['language_id']])) {
				$data['config_mail_check_status'][$language['language_id']] = $this->request->post['config_mail_check_status' . $language['language_id']];
			} else {
				$data['config_mail_check_status'][$language['language_id']] = $this->config->get('config_mail_check_status' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_server' . $language['language_id']])) {
				$data['config_mail_check_server'][$language['language_id']] = $this->request->post['config_mail_check_server' . $language['language_id']];
			} else {
				$data['config_mail_check_server'][$language['language_id']] = $this->config->get('config_mail_check_server' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_nick' . $language['language_id']])) {
				$data['config_mail_check_nick'][$language['language_id']] = $this->request->post['config_mail_check_nick' . $language['language_id']];
			} else {
				$data['config_mail_check_nick'][$language['language_id']] = $this->config->get('config_mail_check_nick' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_payment_method' . $language['language_id']])) {
				$data['config_mail_check_payment_method'][$language['language_id']] = $this->request->post['config_mail_check_payment_method' . $language['language_id']];
			} else {
				$data['config_mail_check_payment_method'][$language['language_id']] = $this->config->get('config_mail_check_payment_method' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_payment_date' . $language['language_id']])) {
				$data['config_mail_check_payment_date'][$language['language_id']] = $this->request->post['config_mail_check_payment_date' . $language['language_id']];
			} else {
				$data['config_mail_check_payment_date'][$language['language_id']] = $this->config->get('config_mail_check_payment_date' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_currency' . $language['language_id']])) {
				$data['config_mail_check_currency'][$language['language_id']] = $this->request->post['config_mail_check_currency' . $language['language_id']];
			} else {
				$data['config_mail_check_currency'][$language['language_id']] = $this->config->get('config_mail_check_currency' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_payment_num' . $language['language_id']])) {
				$data['config_mail_check_payment_num'][$language['language_id']] = $this->request->post['config_mail_check_payment_num' . $language['language_id']];
			} else {
				$data['config_mail_check_payment_num'][$language['language_id']] = $this->config->get('config_mail_check_payment_num' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_payment_info' . $language['language_id']])) {
				$data['config_mail_check_payment_info'][$language['language_id']] = $this->request->post['config_mail_check_payment_info' . $language['language_id']];
			} else {
				$data['config_mail_check_payment_info'][$language['language_id']] = $this->config->get('config_mail_check_payment_info' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_order_info' . $language['language_id']])) {
				$data['config_mail_check_order_info'][$language['language_id']] = $this->request->post['config_mail_check_order_info' . $language['language_id']];
			} else {
				$data['config_mail_check_order_info'][$language['language_id']] = $this->config->get('config_mail_check_order_info' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_order' . $language['language_id']])) {
				$data['config_mail_check_order'][$language['language_id']] = $this->request->post['config_mail_check_order' . $language['language_id']];
			} else {
				$data['config_mail_check_order'][$language['language_id']] = $this->config->get('config_mail_check_order' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_my_orders' . $language['language_id']])) {
				$data['config_mail_check_my_orders'][$language['language_id']] = $this->request->post['config_mail_check_my_orders' . $language['language_id']];
			} else {
				$data['config_mail_check_my_orders'][$language['language_id']] = $this->config->get('config_mail_check_my_orders' . $language['language_id']);
			}

			if (isset($this->request->post['config_mail_check_payment_sum' . $language['language_id']])) {
				$data['config_mail_check_payment_sum'][$language['language_id']] = $this->request->post['config_mail_check_payment_sum' . $language['language_id']];
			} else {
				$data['config_mail_check_payment_sum'][$language['language_id']] = $this->config->get('config_mail_check_payment_sum' . $language['language_id']);
			}
