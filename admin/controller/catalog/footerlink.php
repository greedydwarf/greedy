...
class ControllerCatalogFooterlink extends Controller {
	...
	protected function getList() {
		...
		$this->response->setOutput($this->load->view('catalog/footerlink_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
//print_r($data['footer']); die();
		$this->response->setOutput($this->load->view('catalog/footerlink_form.tpl', $data));
	}
