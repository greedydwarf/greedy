...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'nick_name'      => $result['firstname'],
				'total_usd'      => $result['total_usd'],
				'server'      => $result['lastname'],
				'game'      => $result['game'],
		...
		$data['column_nick_name'] = $this->language->get('Ник в игре');
		$data['column_game'] = $this->language->get('Игра');
		$data['column_quantity'] = $this->language->get('Количество');
		$data['column_server'] = $this->language->get('Сервер');
		$data['column_status'] = $this->language->get('column_status');
		$data['column_total'] = $this->language->get('Сумма р.');
		$data['column_total_usd'] = $this->language->get('Сумма $');
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['text_payment_address'] = $this->language->get('Внутренний номер платежа в Unitpay');
			...
			$data['column_quantity'] = $this->language->get('column_quantity');
			$data['column_price'] = $this->language->get('column_price');
			$data['column_total'] = $this->language->get('Сумма p');
			$data['column_delivery'] = $this->language->get('Способ доставки');
			$data['column_total_usd'] = $this->language->get('Сумма $');
