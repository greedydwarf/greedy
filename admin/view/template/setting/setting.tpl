<?php echo $header; ?> <?php echo 'ghbdtn'; ?><?php echo $column_left; ?>
<div id="content">
            ...
            <div class="tab-pane" id="tab-mail">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="theme-mail<?php echo $language['language_id']; ?>">Theme</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_theme<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_theme[$language['language_id']]; ?>" placeholder="<?php echo $entry_mail_smtp_timeout; ?>" id="theme-mail<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                        <label class="col-sm-2 control-label" for="mail<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></label>
                        <div class="col-sm-10">
                          <textarea name="config_mail_contentmail<?php echo $language['language_id']; ?>" placeholder="<?php echo $entry_description; ?>" id="mail<?php echo $language['language_id']; ?>"><?php echo $config_mail_contentmail[$language['language_id']]; ?></textarea>
                        </div>
                  </div>
                  <h2>Чек</h2>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_product<?php echo $language['language_id']; ?>">Товар</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_product<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_product[$language['language_id']]; ?>"  id="config_mail_check_product<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_quantity<?php echo $language['language_id']; ?>">Количество</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_quantity<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_quantity[$language['language_id']]; ?>"  id="config_mail_check_quantity<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_sum<?php echo $language['language_id']; ?>">Сумма</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_sum<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_sum[$language['language_id']]; ?>"  id="config_mail_check_sum<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_status<?php echo $language['language_id']; ?>">Статус заказа</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_status<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_status[$language['language_id']]; ?>"  id="config_mail_check_status<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_server<?php echo $language['language_id']; ?>">Сервер</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_server<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_server[$language['language_id']]; ?>"  id="config_mail_check_server<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_nick<?php echo $language['language_id']; ?>">Ник персонажа</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_nick<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_nick[$language['language_id']]; ?>"  id="config_mail_check_nick<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_payment_method<?php echo $language['language_id']; ?>">Способ оплаты</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_payment_method<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_payment_method[$language['language_id']]; ?>"  id="config_mail_check_payment_method<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_payment_date<?php echo $language['language_id']; ?>">Дата перевода</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_payment_date<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_payment_date[$language['language_id']]; ?>"  id="config_mail_check_payment_date<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_currency<?php echo $language['language_id']; ?>">Валюта</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_currency<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_currency[$language['language_id']]; ?>"  id="config_mail_check_currency<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_payment_num<?php echo $language['language_id']; ?>">Номер платежа</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_payment_num<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_payment_num[$language['language_id']]; ?>"  id="config_mail_check_payment_num<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_payment_info<?php echo $language['language_id']; ?>">Информация о платеже</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_payment_info<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_payment_info[$language['language_id']]; ?>"  id="config_mail_check_payment_info<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_order_info<?php echo $language['language_id']; ?>">Информация о заказе</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_order_info<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_order_info[$language['language_id']]; ?>"  id="config_mail_check_order_info<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_order<?php echo $language['language_id']; ?>">Заказ</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_order<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_order[$language['language_id']]; ?>"  id="config_mail_check_order<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_my_orders<?php echo $language['language_id']; ?>">Мои заказы</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_my_orders<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_my_orders[$language['language_id']]; ?>"  id="config_mail_check_my_orders<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="config_mail_check_payment_sum<?php echo $language['language_id']; ?>">Сумма платежа</label>
                    <div class="col-sm-10">
                      <input type="text" name="config_mail_check_payment_sum<?php echo $language['language_id']; ?>" value="<?php echo $config_mail_check_payment_sum[$language['language_id']]; ?>"  id="config_mail_check_payment_sum<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                </div>
                <?php } ?>
...
<?php foreach ($languages as $language) { ?>
$('#mail<?php echo $language['language_id']; ?>').summernote({height: 300});
<?php } ?>
$('#language').children().first().click();
//--></script>
