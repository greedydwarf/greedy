...
class ControllerAccountRegister extends Controller {
	...
	public function addNewCustomerFast() {
		$json = array();
		...
		if (isset($this->request->post['login-register'])) {
			$register_info['login-register'] = $this->request->post['login-register'];
		} else {
			$register_info['login-register'] = 0;
		}

		if (isset($this->request->post['pass-register'])) {
			$register_info['pass-register'] = $this->request->post['pass-register'];
		} else {
			$register_info['pass-register'] = 0;
		}
		$customer_id = $this->model_account_customer->quickRegisterFromHome($register_info);
		...
		if ($customer_id != 0){
			...
			$json['already_exist'] = 'already exists(уже существует)';
		}
